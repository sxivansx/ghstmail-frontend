      ...
      <div className="flex-1 flex items-center justify-center px-4 -mt-16">
        <div className="w-full max-w-sm">
          <div className="opacity-0 animate-fade-up text-center mb-8">
            ...
            <p className="text-void-300 mt-2 text-sm">Create your account in seconds</p>
          </div>
          ...
          <p className="opacity-0 animate-fade-up-delay-2 text-center text-sm text-void-400 mt-6">
            ...
            <Link href="/login" className="text-phantom-400 hover:text-phantom-300 font-medium transition-colors">
              Sign in
            </Link>
          </p>
        </div>
